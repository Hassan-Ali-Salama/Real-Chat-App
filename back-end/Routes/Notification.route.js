...
router.get("/getallNotify", AuthMiddleware, getAllNotifications);
router.get("/notify/:id", AuthMiddleware, getNotification);
router.post("/addNotify", AuthMiddleware, AddNotification);
router.delete("/deleteNotify/:id", AuthMiddleware, deleteNotificition);
